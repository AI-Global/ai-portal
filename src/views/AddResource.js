        ...
        <Content style={{ padding: '0 50px'}}>
          <Row justify="center" style={{ marginTop: '4rem' }}>
            <Col 
              ...
              <Typography><Title style={{minWidth:'500px'}}>Add a Resource</Title></Typography>
              <Form
                labelCol={{ span: 4}}
                wrapperCol={{ span: 10 }}
                name="basic"
              ...
              >
                ...
                <FormField field="URL Source" text="This should be a valid URL that directs to the resource." req="true"/>
                <Form.Item>
