...
module.exports = (app) => {
  ...
  firewall.get('/api/organizations', async (req, res) => {
  ...
  firewall.get('/api/organizations/:_id', async (req, res) => {
  ...
  firewall.get('/api/organizations/:_id/resources', async (req, res) => {
